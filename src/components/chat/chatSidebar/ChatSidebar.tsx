          ...
          {userList.map((user: UserListResponseData) => (
            ...
            >
              <div className="flex flex-row gap-3 items-center">
                <img src={user.profile_picture || personImage} alt="profile" width={60} height={60} className="w-[50px] h-[50px] xl:w-[60px] xl:h-[60px] " />
              ...
              <div className="flex flex-col justify-center gap-2.5 items-end">
                <p className="text-[10px] xl:text-xs leading-4 xl:leading-5 text-gray-600 font-normal">{user.last_message_at}</p>
                {user.unread_count > 0 && (
